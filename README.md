...
The 'dbt_test' project was generated by using the default template.

* `src/`: Python source code for this project.
  * `src/dbt_test/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dbt_test_etl` to your workspace.
